...
const paths: Record<IconName, React.ReactNode> = {
  sparkles: (
    <>
      <path d="M12 2.7c.45 4.25 2.75 6.55 7 7-4.25.45-6.55 2.75-7 7-.45-4.25-2.75-6.55-7-7 4.25-.45 6.55-2.75 7-7Z" />
      <path d="M19 15.5c.2 1.9 1.1 2.8 3 3-1.9.2-2.8 1.1-3 3-.2-1.9-1.1-2.8-3-3 1.9-.2 2.8-1.1 3-3Z" />
    </>
  ),
  plus: (
    <>
  ...
  refresh: (
    <>
      <path d="M20 7v5h-5" />
      <path d="M18.2 17a8 8 0 1 1 1.6-8l.2 3" />
    </>
  ),
  ...
  attachment: (
    <path d="m8.5 12.5 6.8-6.8a3 3 0 0 1 4.2 4.2l-8.8 8.8a5 5 0 0 1-7.1-7.1l8.5-8.5M7 15l8.2-8.2" />
  ),
  fork: (
    <>
      <circle cx="6" cy="5" r="2" />
      ...
      <path d="M6 7v3c0 4 3 6 10 6M8 9c5 0 4-2 8-2" />
    </>
  ),
  file: (
    <>
  ...
  artifact: (
    <>
      <rect x="3" y="4" width="18" height="16" rx="2" />
      <path d="m8 9-3 3 3 3M16 9l3 3-3 3M14 7l-4 10" />
    </>
  ),
  memory: (
    <>
      <path d="M8 5a3 3 0 0 1 5-2 3 3 0 0 1 4 4 3 3 0 0 1 1 5 3 3 0 0 1-1 5 3 3 0 0 1-4 4 3 3 0 0 1-5-2 3 3 0 0 1-2-5 3 3 0 0 1 0-5 3 3 0 0 1 2-4Z" />
      <path d="M12 4v16M8 9h4M12 15h4" />
    </>
  ),
  review: (
    <>
